...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        int[] row; 
        int multiple, distribution; 
        int numberOfPeople, candies;

        // initialize local variables 
        candies = 8192; 
        numberOfPeople = 100;
        row = new int[numberOfPeople];
        multiple = 0;
        ...
        while (candies > 0)
        {
            ...
            {
                distribution = (multiple * numberOfPeople) + (i + 1);
        ...
        {
            Console.WriteLine("distribution[" + i + "] = " + row[i]); 
        }
        Console.ReadLine(); 
