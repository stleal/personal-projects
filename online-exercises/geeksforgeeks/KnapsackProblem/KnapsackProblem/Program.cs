...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        maxPossibleProfit = KnapsackProblem(weights, profits, capacity, count);

        // print
        Console.WriteLine("Maximum Profit: " + maxPossibleProfit);
