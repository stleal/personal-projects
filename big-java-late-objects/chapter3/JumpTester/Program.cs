...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        while (running)
        {
            ...
            p.SetMass(GetMassByRadiusAndLaunchVelocity(p.GetRadius(), (vLaunch/2.23694)));

            // calculate the escape velocity
            p.SetEscapeVelocity(GetEscapeVelocityByRadiusAndMass(p.GetRadius(), p.GetMass()));
    ...
    public static double GetMassByRadiusAndLaunchVelocity(double radius, double vLaunch)
    {
    ...
    public static double GetEscapeVelocityByRadiusAndMass(double radius, double mass)
    {
